...
((SELECT user_id FROM users WHERE email = 'john.doe@example.com'),
 ...
 2, TRUE),  -- Selected for checkout
((SELECT user_id FROM users WHERE email = 'john.doe@example.com'),
 (SELECT product_id FROM products WHERE product_name = 'Leather Jacket'), 
 1, TRUE),  -- Selected for checkout
((SELECT user_id FROM users WHERE email = 'john.doe@example.com'),
 (SELECT product_id FROM products WHERE product_name = 'Wool Scarf'), 
...
-- Revised orders data (only for items marked for checkout)
